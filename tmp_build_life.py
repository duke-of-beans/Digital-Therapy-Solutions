...
<head>
    ...
    <title>Online Therapy for Life Transitions — Finding Footing Again | Digital Therapy Solutions</title>
    <meta name="description" content="Find the best online therapy platforms for life transitions. Expert-reviewed platforms with therapists specializing in adjustment, grief, and navigating major change. Updated monthly.">
...
<body>
    ...
    <nav aria-label="Breadcrumb" class="breadcrumb" style="max-width:var(--table-width);margin:0 auto;padding:var(--space-xs) var(--space-md);">
        <a href="index.html">Home</a><span class="breadcrumb__sep">/</span><a href="conditions.html">Conditions</a> / Life Transitions
    </nav>
        ...
        <div class="section-wrapper section-wrapper--hero">
            ...
            <div class="hero-text">
                <h1>Big changes don\'t come with instructions. Therapy helps you write them.</h1>
                <p class="hero-subhead"><em>Divorce, job loss, relocation, retirement, loss &mdash; transitions hit differently when you\'re carrying them alone.</em></p>
                <p class="hero-subhead hero-subhead--follow">These platforms have therapists who specialize in adjustment, grief, and finding footing again.</p>
                <div class="trust-row">
        ...
        <div class="section-wrapper section-wrapper--alt">
            <div class="content-container">
                <h2 class="section-heading">Platforms We Recommend for Life Transitions</h2>
                <p class="section-context">Each platform below was personally tested and clinically reviewed by <strong>Dr. Sarah Chen, LCSW</strong> &mdash; a licensed therapist specializing in adjustment and life transitions.</p>
                ...
                <article class="platform-card platform-card--featured reveal">
                    <div class="platform-card__header">
                        ...
                        <div class="platform-card__identity">
                            ...
                            <p class="platform-card__tagline">Best for transitions &mdash; therapist specialties include adjustment and life change</p>
                        </div>
                ...
                <article class="platform-card reveal reveal-delay-1" data-rank="2">
                    <div class="platform-card__header">
                        ...
                        <div class="platform-card__identity">
                            ...
                            <p class="platform-card__tagline">Best with insurance &mdash; browse therapists by specialty before booking</p>
                        </div>
                        <div class="platform-card__score">
                    ...
                    <div class="platform-card__body">
                        <p>Grow Therapy lets you filter by specialty &mdash; you can specifically search for therapists who work with grief, adjustment disorder, or life transitions. Profiles include bios and specialties so you know what you\'re getting before the first session. In-network with most major plans.</p>
                    </div>
                    ...
                    <div class="platform-card__cta">
                        <span class="offer-tag">&#10022; Filter by "life transitions" in therapist search</span>
                ...
                <!-- CARD 3: Online-Therapy.com -->
                <article class="platform-card reveal reveal-delay-2" data-rank="3">
                    <div class="platform-card__header">
                        <div class="platform-card__logo" style="background:#4CAF50;color:#fff;font-weight:700;font-size:1.1rem;">
                            <img src="../assets/logos/online-therapy.webp" alt="Online-Therapy.com logo" onerror="this.style.display=\'none\';this.parentElement.style.background=\'#4CAF50\';this.parentElement.style.color=\'#fff\';this.parentElement.textContent=\'OT\';">
                        </div>
                        <div class="platform-card__identity">
                            <h3 class="platform-card__name">Online-Therapy.com</h3>
                            <p class="platform-card__tagline">Best structured program &mdash; CBT-based tools alongside live sessions</p>
                        </div>
                        <div class="platform-card__score">
                    ...
                    <div class="platform-card__body">
                        <p>Online-Therapy.com pairs weekly sessions with CBT worksheets and journaling tools &mdash; useful during transitions where you want structured support between sessions, not just talk. The $45&ndash;80/week pricing makes consistent weekly therapy accessible even without insurance.</p>
                    </div>
                    <div class="platform-card__details"><span class="detail detail--price"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6"/><path d="M8 4.5v7M6 6.5c0-.8.9-1.5 2-1.5s2 .7 2 1.5-.9 1.5-2 1.5-2 .7-2 1.5.9 1.5 2 1.5"/></svg> $45&ndash;80/week</span><span class="detail detail--no-insurance"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6"/><path d="M5.5 5.5l5 5"/></svg> No insurance required</span><span class="detail detail--format"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="3" width="12" height="10" rx="1.5"/><circle cx="8" cy="8" r="1.5"/></svg> Video</span><span class="detail detail--format"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M3 7h10M3 10h7"/></svg> CBT worksheets</span><span class="detail detail--format"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M3 2h10a1 1 0 011 1v10a1 1 0 01-1 1H3a1 1 0 01-1-1V3a1 1 0 011-1zM5 6h6M5 9h4"/></svg> Journaling</span></div>
                    <div class="platform-card__cta">
                        <span class="offer-tag">&#10022; CBT tools between sessions &mdash; structure during uncertain times</span>
                        <a href="#" class="cta-button">Get Started on Online-Therapy.com</a>
                    </div>
                    <div class="platform-card__meta">
                        <span>Reviewed by Dr. Sarah Chen, LCSW</span>
                    </div>
                ...
                <div class="forks-layout reveal">
                    <div class="forks-text">
                        ...
                        <div class="forks-links">
                            <a href="grief.html" class="fork-link">Online therapy for grief <span>&rarr;</span></a>
                            <a href="stress.html" class="fork-link">Online therapy for stress <span>&rarr;</span></a>
                            <a href="burnout.html" class="fork-link">Online therapy for burnout <span>&rarr;</span></a>
            ...
            <div class="content-container">
                ...
                <div class="reviewer-card reveal">
                    ...
                    <div class="reviewer-card__content">
                        ...
                        <p class="reviewer-card__specialties">Life Transitions &middot; Grief &middot; Adjustment &middot; CBT</p>
                        <div class="reviewer-card__bio">
                            Dr. Chen is a Licensed Clinical Social Worker with 12 years of experience helping clients navigate major life changes. She reviews all condition guides on Digital Therapy Solutions to ensure clinical accuracy.
                        </div>
...
with open(r'D:\Work\Digital-Therapy-Solutions\output\life-transitions.html', 'w', encoding='utf-8') as f:
    f.write(html)
print('life-transitions.html written OK')
