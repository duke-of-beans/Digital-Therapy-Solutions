    ...
    <nav aria-label="Breadcrumb" class="breadcrumb" style="max-width:var(--table-width);margin:0 auto;padding:var(--space-xs) var(--space-md);">
        ...
        <div class="section-wrapper section-wrapper--alt">
            <div class="content-container">
                ...
                <p class="section-context">Each platform below was personally tested and clinically reviewed by <strong>Dr. Sarah Chen, LCSW</strong> &mdash; a licensed therapist specializing in men\'s mental health.</p>
                ...
                <div class="reviewer-card reveal">
                    ...
                    <div class="reviewer-card__content">
                        ...
                        <div class="reviewer-card__bio">
                            Dr. Chen is a Licensed Clinical Social Worker with 12 years of experience treating anxiety and identity-related concerns. She reviews all condition guides on Digital Therapy Solutions to ensure clinical accuracy.
                        </div>
