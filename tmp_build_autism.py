...
<head>
    ...
    <title>Online Therapy for Autism &amp; Neurodivergence — Affirming, Not Corrective | Digital Therapy Solutions</title>
    <meta name="description" content="Find the best online therapy platforms for autism and neurodivergence. Expert-reviewed platforms with neurodiversity-affirming therapists experienced with autistic adults. Updated monthly.">
...
<body>
    ...
    <nav aria-label="Breadcrumb" class="breadcrumb" style="max-width:var(--table-width);margin:0 auto;padding:var(--space-xs) var(--space-md);">
        <a href="index.html">Home</a><span class="breadcrumb__sep">/</span><a href="conditions.html">Conditions</a> / Autism &amp; Neurodivergence
    </nav>
        ...
        <div class="section-wrapper section-wrapper--hero">
            ...
            <div class="hero-text">
                <h1>Therapy for autistic adults should be affirming, not corrective.</h1>
                <p class="hero-subhead"><em>The right therapist understands how you process &mdash; and works with it, not against it.</em></p>
                <p class="hero-subhead hero-subhead--follow">These platforms have therapists with neurodiversity-affirming training and real experience with autistic adults.</p>
                <div class="trust-row">
        ...
        <div class="section-wrapper section-wrapper--alt">
            <div class="content-container">
                <h2 class="section-heading">Platforms We Recommend for Autism &amp; Neurodivergence</h2>
                <p class="section-context">Each platform below was personally tested and clinically reviewed by <strong>Dr. Sarah Chen, LCSW</strong> &mdash; a licensed therapist with experience in neurodiversity-affirming care.</p>

                <!-- CARD 1: Grow Therapy — Top Pick -->
                <article class="platform-card platform-card--featured reveal">
                    <div class="platform-card__header">
                        ...
                        <div class="platform-card__identity">
                            ...
                            <p class="platform-card__tagline">Best for finding neurodiversity-affirming therapists &mdash; searchable by specialty</p>
                        </div>
                    ...
                    <div class="platform-card__body">
                        <p>Grow Therapy\'s profile-browse model is the right fit here &mdash; you can search specifically for therapists with autism or neurodivergence experience, read their bios, and verify their approach before booking. For autistic adults, therapist fit matters more than platform features. Insurance-based pricing brings the cost down significantly for most plans.</p>
                    </div>
                    <div class="platform-card__details"><span class="detail detail--insurance"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M8 1L2 4v4c0 3.3 2.6 6.4 6 7 3.4-.6 6-3.7 6-7V4L8 1z"/><path d="M6 8l2 2 3-3"/></svg> Insurance-based pricing</span><span class="detail detail--price"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6"/><path d="M8 4.5v7M6 6.5c0-.8.9-1.5 2-1.5s2 .7 2 1.5-.9 1.5-2 1.5-2 .7-2 1.5.9 1.5 2 1.5"/></svg> $100&ndash;200/session self-pay</span><span class="detail detail--format"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="3" width="12" height="10" rx="1.5"/><circle cx="8" cy="8" r="1.5"/></svg> Video</span><span class="detail detail--format"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M4 8 Q4 4 8 4 Q12 4 12 8 L12 12 Q12 14 10 14 L6 14 Q4 14 4 12Z"/></svg> In-person options</span></div>
                    <div class="platform-card__cta">
                        <span class="offer-tag">&#10022; Search "autism" or "neurodivergence" in therapist specialty filter</span>
                ...
                <article class="platform-card reveal reveal-delay-1" data-rank="2">
                    <div class="platform-card__header">
                        ...
                        <div class="platform-card__identity">
                            ...
                            <p class="platform-card__tagline">Best for access and flexibility &mdash; async messaging suits many autistic clients</p>
                        </div>
                        <div class="platform-card__score">
                ...
                <!-- CARD 3: Inclusive Therapists -->
                <article class="platform-card reveal reveal-delay-2" data-rank="3">
                    <div class="platform-card__header">
                        <div class="platform-card__logo" style="background:#7B1FA2;color:#fff;font-weight:700;font-size:1.1rem;">
                            <img src="../assets/logos/inclusive-therapists.webp" alt="Inclusive Therapists logo" onerror="this.style.display=\'none\';this.parentElement.style.background=\'#7B1FA2\';this.parentElement.style.color=\'#fff\';this.parentElement.textContent=\'IT\';">
                        </div>
                        <div class="platform-card__identity">
                            <h3 class="platform-card__name">Inclusive Therapists</h3>
                            <p class="platform-card__tagline">Best directory for marginalized identities &mdash; neurodivergent-affirming focus</p>
                        </div>
                        <div class="platform-card__score">
                    ...
                    <div class="platform-card__body">
                        <p>Inclusive Therapists is a directory specifically built for people seeking therapists who affirm their identity &mdash; including neurodivergent and autistic clients. You browse profiles, filter by neurodiversity affirmation, and connect directly. Pricing varies by therapist; many offer sliding scale rates.</p>
                    </div>
                    <div class="platform-card__details"><span class="detail detail--price"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6"/><path d="M8 4.5v7M6 6.5c0-.8.9-1.5 2-1.5s2 .7 2 1.5-.9 1.5-2 1.5-2 .7-2 1.5.9 1.5 2 1.5"/></svg> Varies by therapist</span><span class="detail detail--price"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M8 1L2 4v4c0 3.3 2.6 6.4 6 7 3.4-.6 6-3.7 6-7V4L8 1z"/><path d="M6 8l2 2 3-3"/></svg> Sliding scale available</span><span class="detail detail--format"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="3" width="12" height="10" rx="1.5"/><circle cx="8" cy="8" r="1.5"/></svg> Video</span><span class="detail detail--format"><svg class="detail__icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M4 8 Q4 4 8 4 Q12 4 12 8 L12 12 Q12 14 10 14 L6 14 Q4 14 4 12Z"/></svg> In-person</span></div>
                    <div class="platform-card__cta">
                        <span class="offer-tag">&#10022; Filter by neurodivergent-affirming in the therapist search</span>
                        <a href="#" class="cta-button">Browse Therapists on Inclusive Therapists</a>
                    </div>
                    <div class="platform-card__meta">
                        <span>Reviewed by Dr. Sarah Chen, LCSW</span>
                    </div>
                ...
                <div class="forks-layout reveal">
                    <div class="forks-text">
                        ...
                        <div class="forks-links">
                            <a href="adhd.html" class="fork-link">Online therapy for ADHD <span>&rarr;</span></a>
                            <a href="anxiety.html" class="fork-link">Online therapy for anxiety <span>&rarr;</span></a>
                            <a href="teen.html" class="fork-link">Online therapy for teens <span>&rarr;</span></a>
                            <a href="conditions.html" class="fork-link">All conditions <span>&rarr;</span></a>
                        </div>
                    </div>
                    <div class="forks-image">
                        <img src="../assets/video-call-earbuds.webp" alt="Person during an online therapy session" class="forks-image__img">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="content-container">
                ...
                <div class="reviewer-card reveal">
                    ...
                    <div class="reviewer-card__content">
                        ...
                        <p class="reviewer-card__specialties">Neurodivergence &middot; Autism &middot; ADHD &middot; Identity-Affirming Care</p>
                        <div class="reviewer-card__bio">
                            Dr. Chen is a Licensed Clinical Social Worker with 12 years of experience providing neurodiversity-affirming therapy. She reviews all condition guides on Digital Therapy Solutions to ensure clinical accuracy.
                        </div>
...
with open(r'D:\Work\Digital-Therapy-Solutions\output\autism.html', 'w', encoding='utf-8') as f:
    f.write(html)
print('autism.html written OK')
